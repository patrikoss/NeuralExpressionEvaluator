...
class OpenCVFrameHandler(BaseFrameHandler):
    ...
    def get_symbols(self, frame):
        """Returns symbol boxes found in the frame"""
        ...
        symbols = (encode_symbol(symbol, None, None) for symbol in symbols)
        ...
        symbol_boxes = [SymbolBox(classification_image, top, left, bottom, right, prob, label)
    ...
    def show_frames(self, frame, symbols, expressions):
        ...
        for i in range(m):
            ...
            cv2.putText(decoded_frame, symbol.prediction_cls.decode(),
